...
PPT_PATH = r"C:\LOTO PLACARDS FC08\PLC70\02. Energy Point Tags\PLC70_LOTO_EnergyTags_177_Template_Italian.pptx"

SHEET_NAME = "EnergyTags"  # Adjust sheet name
TOTAL_TAGS = 177
TAGS_PER_SLIDE = 10
START_ROW = 2  # Excel row M2 = first tag
EXCEL_COL = "M"  # Column containing the tag values
...
def main():
    print("Starting PLC70 Energy Tag update...")
    ...
    print("DONE! 177 Energy Tags Updated Successfully!")
