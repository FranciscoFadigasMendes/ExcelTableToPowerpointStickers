...
ppt_file_url: str = r"C:\LOTO PLACARDS FC08\PLC70\03. LOTO Information Sticker\PLC70_LOTO_Information_177_Stickers_Template_Italian.pptx"
stickers_per_slide: int = 6
total_stickers: int = 177
...
def main() -> None:
    ...
    ws = wb.Sheets("Info_Tags_PLC70_FC08_177")
