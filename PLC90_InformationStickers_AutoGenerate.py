...
ppt_file_url: str = r"C:\LOTO PLACARDS FC08\PLC90\03. LOTO Information Sticker\PLC90_LOTO_Information_228_Stickers_Template_Italian.pptx"
stickers_per_slide: int = 6
total_stickers: int = 228
...
def main() -> None:
    ...
    ws = wb.Sheets("Info_Tags_PLC90_FC08_228")
