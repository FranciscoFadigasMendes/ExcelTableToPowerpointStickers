...
PPT_PATH: str = r"C:\LOTO PLACARDS FC08\PLC40\02. Energy Point Tags\PLC40_LOTO_EnergyTags_105_Template_Italian.pptx"

TOTAL_TAGS: int = 105
TAGS_PER_SLIDE: int = 10

START_ROW: int = 2  # Excel Row E2 → Tag 1
EXCEL_COL: str = "G"  # Source column for tag label
...
def main() -> None:
    ...
    print("Starting PLC40 Energy Tag update...")
    ...
    print("DONE! 105 Energy Tags Updated Successfully!")
