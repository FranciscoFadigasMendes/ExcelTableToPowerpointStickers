...
PPT_PATH = r"C:\LOTO PLACARDS FC08\PLC40\02. Energy Point Tags\PLC40_LOTO_EnergyTags_105_Template_Italian.pptx"

SHEET_NAME = "EnergyTags"  # Adjust sheet name
TOTAL_TAGS = 105
TAGS_PER_SLIDE = 10
START_ROW = 2  # Excel row G2 = first tag
EXCEL_COL = "G"  # Column containing the tag values
