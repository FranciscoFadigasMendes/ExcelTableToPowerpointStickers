...
ppt_file_url: str = r"C:\LOTO PLACARDS FC08\PLC80\03. LOTO Information Sticker\PLC80_LOTO_Information_76_Stickers_Template_Italian.pptx"
stickers_per_slide: int = 6
total_stickers: int = 76
...
def main() -> None:
    ...
    ws = wb.Sheets("Info_Tags_PLC80_FC08_76")
