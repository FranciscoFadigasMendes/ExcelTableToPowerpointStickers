...
PPT_PATH = r"C:\LOTO PLACARDS FC08\PLC80\02. Energy Point Tags\PLC80_LOTO_EnergyTags_76_Template_Italian.pptx"

SHEET_NAME = "EnergyTags"  # Adjust sheet name
TOTAL_TAGS = 76
TAGS_PER_SLIDE = 10
START_ROW = 2  # Excel row O2 = first tag
EXCEL_COL = "O"  # Column containing the tag values
...
def main():
    print("Starting PLC80 Energy Tag update...")
    ...
    print("DONE! 76 Energy Tags Updated Successfully!")
