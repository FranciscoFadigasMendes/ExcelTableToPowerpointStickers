...
PPT_PATH = r"C:\LOTO PLACARDS FC08\PLC60\02. Energy Point Tags\PLC60_LOTO_EnergyTags_154_Template_Italian.pptx"

SHEET_NAME = "EnergyTags"  # Adjust sheet name
TOTAL_TAGS = 154
TAGS_PER_SLIDE = 10
START_ROW = 2  # Excel row K2 = first tag
EXCEL_COL = "K"  # Column containing the tag values
...
def main():
    print("Starting PLC60 Energy Tag update...")
